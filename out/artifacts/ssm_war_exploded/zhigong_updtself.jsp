                ...
                <form action="zhigongupdate.do" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_quyu8" data-value="${Info.html(mmm.quyu)}" id="quyu" name="quyu" style="width: 250px">
                                ...
                                <script>
                                    $(".class_quyu8").val($(".class_quyu8").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_xingbie9" data-value="${Info.html(mmm.xingbie)}" id="xingbie" name="xingbie" style="width: 250px">
