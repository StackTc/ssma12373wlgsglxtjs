...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加预约:</div>
            <div class="panel-body">
                <form action="yuyueinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-inline">
                                    <select class="form-control" data-fields="huowu,jine" id="leixing" name="leixing" onchange="getAjaxData('huowu',this,this.value)">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control select-update" placeholder="输入货物" style="width: 150px" id="huowu" name="huowu" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_quyu14" data-value="" id="quyu" name="quyu" style="width: 250px">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入目的地" style="width: 150px" id="mudidi" name="mudidi" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入发货地" style="width: 150px" id="fahuodi" name="fahuodi" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入发货人电话" style="width: 150px" id="fahuorendianhua" name="fahuorendianhua" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入发货人" style="width: 150px" id="fahuoren" name="fahuoren" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入收货人" style="width: 150px" id="shouhuoren" name="shouhuoren" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'zh-cn'})" style="width:200px;" readonly="readonly"
                                id="shijian" name="shijian" value="${Info.date("yyyy-MM-dd HH:mm:ss")}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
