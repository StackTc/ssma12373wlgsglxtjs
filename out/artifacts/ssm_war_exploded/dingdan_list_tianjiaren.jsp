            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_quyu18" data-value="${param.quyu}" id="quyu" name="quyu">
                        ...
                        <script>
                            $(".class_quyu18").val($(".class_quyu18").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        目的地
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_yunshu19" data-value="${param.yunshu}" id="yunshu" name="yunshu">
                            <option value="">请选择</option>
                        ...
                        <script>
                            $(".class_yunshu19").val($(".class_yunshu19").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        备注
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>${map.huowu}</td>
                                <td>${map.jine}</td>
                                <td><ssm:sql var="mapquyu7" type="find">SELECT quyu,id FROM quyu where id='${map.quyu}'</ssm:sql>${mapquyu7.quyu}</td>
                                <td>${map.mudidi}</td>
                                <td>${map.fahuodi}</td>
                                ...
                                <td><ssm:sql var="mapyunshu8" type="find">SELECT yunshu,id FROM yunshu where id='${map.yunshu}'</ssm:sql>${mapyunshu8.yunshu}</td>
                                <td>${map.beizhu}</td>
                                <td>${map.caozuoren}</td>
                                <td align="center">
