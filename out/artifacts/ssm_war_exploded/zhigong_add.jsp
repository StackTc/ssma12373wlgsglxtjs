...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加职工:</div>
            <div class="panel-body">
                <form action="zhigonginsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=insert&table=zhigong&col=gonghao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_quyu6" data-value="" id="quyu" name="quyu" style="width: 250px">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_xingbie7" data-value="" id="xingbie" name="xingbie" style="width: 250px">
