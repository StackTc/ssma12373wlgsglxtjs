                ...
                <h1>
                    <c:choose>
                        <c:when test="${sessionScope.touxiang != null && sessionScope.touxiang !=  '' }">
                            <img src="${sessionScope.touxiang}" class="radius-circle rotate-hover" style="width: 50px; height: 50px" alt="" /> </c:when
                        ><c:otherwise>
                            <img src="htstyle/images/y.jpg" class="radius-circle rotate-hover" style="width: 50px; height: 50px" alt="" /> </c:otherwise
                    ></c:choose>
                    物流公司管理系统介绍
                </h1>
            </div>
            <div class="head-l">
                <a class="button button-little bg-green" href="./" target="_parent"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
                <a href="sy.do" target="right" class="button button-little bg-blue syHome"><span class="icon-wrench"></span> 后台主页</a> &nbsp;&nbsp;
                <a class="button button-little bg-red" href="logout.do" onclick="return confirm('确定退出系统？')"><span class="icon-power-off"></span> 退出登录</a>
            </div>
        </div>
        <div class="leftnav">
            ...
            <div class="leftnav-list" id="leftNav">
                ...
                <c:choose> <c:when test="${'职工' == sessionScope.cx }"> <%@ include file="left_zhigong.jsp" %>
 </c:when></c:choose>
            </div>
        </div>
